 ...
 */
class CRM_Trialadmin_Upgrader_Base {

  /**
   * @var CRM_Trialadmin_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Trialadmin_Upgrader(
        'ca.sdda.trialadmin',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Trialadmin_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Trialadmin_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
